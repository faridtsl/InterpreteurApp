...
<main>
    <table>
        ...
        <tr>
            ...
            <td class="grand total">{{(\App\Tools\DevisTools::getDevisById($facture->devi_id)->tva * \App\Tools\DevisTools::getDevisById($facture->devi_id)->total) + \App\Tools\DevisTools::getDevisById($facture->devi_id)->total}}&euro;</td>
        </tr>
        </tbody>
    </table>
