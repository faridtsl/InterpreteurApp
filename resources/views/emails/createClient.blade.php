                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <div mc:edit="std_content00">
                                                                    <h2 class="h2">Welcome to <i>WordAndCo</i></h2>

                                                                    <strong>We're so glad</strong> Customize your template by clicking on the style editor tabs up above. Set your fonts, colors, and styles. After setting your styling is all done you can click here in this area, delete the text, and start adding your own awesome content!
                                                                    <br />
                                                                    <br />
                                                                    <h2 class="h2">How we work</h2>
                                                                    <strong>Work presentation:</strong>
                                                                    Our compagny .., highlight the text you want to style and select the options you set in the style editor in the "styles" drop down box. Want to <a href="http://www.mailchimp.com/kb/article/im-using-the-style-designer-and-i-cant-get-my-formatting-to-change" target="_blank">get rid of styling on a bit of text</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
