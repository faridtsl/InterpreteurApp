...
@section('content')
    <br/>
    <form method="POST" action="/devis/update">
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <table class="table table-bordered table-hover table-sortable" id="tab_logic">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div id="total">
                                                @if(isset($devis))
                                                    <strong>{{$devis->total}}&euro;</strong>
                                                    <script type="text/javascript">
                                                        $("#total").val({{$devis->total}});
                                                    </script>
                                                @endif
                                            </div>
                                        </th>
                                    ...
                                    @else
                                        <tr id='addr0' data-id="0">
                                            ...
                                            <td data-name="del">
                                                <a id="del0" name="del0" class="btn btn-danger glyphicon glyphicon-remove row-remove"></a>
                                            </td>
                                        </tr>
                                    @endif
                                    </tbody>
        ...
        function initMarkersAndWindows(){
            ...
            $('#afficherTout').on('click',function (e) {
                ...
                table2.rows().eq(0).each( function ( index ) {
                    ...
                    var npr = row[16].split(' ');
                    markersNewPage(row[0],cnt,npr[0],npr[1],row[3],row[9],row[7],row[8],row[6],parseFloat(row[14]),parseFloat(row[15]));
                    cnt++;
                } );
                console.log(cnt);
            });
