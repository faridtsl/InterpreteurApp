                    ...
                    <div class="panel-body">
                        <table id="example" class="table table-striped table-bordered display responsive nowrap" width="100%" cellspacing="0">
                            ...
                            @foreach($demandes as $demande)
                                @if(\App\Tools\DemandeTools::tempsRestantMinutes($demande)>=0)
            ...
            <div class="modal-content">
                ...
                <form id="deleteForm" action="delete" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> êtes-vous sûr de bien vouloir supprimer la demande en cours ?</div>
                    </div>
